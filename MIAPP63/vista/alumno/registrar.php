...
<div class="container mt-4">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <h4 class="text-center mb-4">Registrar Alumno</h4>

            <form action="index.php?accion=guardarAlumno" method="POST">
                <div class="mb-2">
                    <label class="form-label">Cédula</label>
                    <input type="number" name="cedula" class="form-control form-control-sm" required>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="curso" class="form-control form-control-sm" required>
                </div>
                <div class="mb-2">
